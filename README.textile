...
@curl -L https://github.com/robhawkes/oh-my-zsh/raw/rawkes/tools/install.sh | sh@

h4. via `wget`

@wget --no-check-certificate https://github.com/robhawkes/oh-my-zsh/raw/rawkes/tools/install.sh -O - | sh@
